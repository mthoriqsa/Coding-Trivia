...
public class quizPHPEX extends AppCompatActivity {

    private QuestionDatabasePHPEX mQuestionLibrary = new QuestionDatabasePHPEX(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_phpex);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mButtonChoice1.getText().toString().contentEquals(mAnswer)){
                    ...
                    Toast.makeText(quizPHPEX.this, "BENAR!", Toast.LENGTH_SHORT).show();
                }
                else {
                    mScore--;
                    lifePoint--;
                    ...
                    zeroScore();
                    Toast.makeText(quizPHPEX.this, "SALAH!", Toast.LENGTH_SHORT).show();
                    //gameOver();
                }
            }
        });
    ...
    private void updateQuestion(){
        try {
            if (countQuiz == QUIZ_COUNT) {
                Intent intent = new Intent(getApplicationContext(), resultPHPEX.class);
                intent.putExtra("phpexScore", mScore);
            ...
            AlertDialog.Builder errorConn = new AlertDialog.Builder(quizPHPEX.this);
            errorConn
    ...
    private void gameOver(){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(quizPHPEX.this);
        alertDialogBuilder
                ...
                .setPositiveButton("Restart",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                startActivity(new Intent(getApplicationContext(), quizPHPEX.class));
                            }
                        })
