...
public class quiz2 extends AppCompatActivity {
    ...
    private QuestionDatabase2 mQuestionLibrary = new QuestionDatabase2(this);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mButtonChoice1.getText().toString().contentEquals(mAnswer)){
                    ...
                    Toast.makeText(quiz2.this, "BENAR!", Toast.LENGTH_SHORT).show();
                }
                else {
                    mScore--;
                    lifePoint--;
                    ...
                    zeroScore();
                    Toast.makeText(quiz2.this, "SALAH!", Toast.LENGTH_SHORT).show();
                    //gameOver();
                }
            }
        });
    ...
    private void updateQuestion(){
        ...
        try {
            if (countQuiz == QUIZ_COUNT) {
                Intent intent = new Intent(getApplicationContext(), resultALGOIN.class);
                intent.putExtra("algoinScore", mScore);
            ...
            AlertDialog.Builder errorConn = new AlertDialog.Builder(quiz2.this);
            errorConn
    ...
    private void gameOver(){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(quiz2.this);
        alertDialogBuilder
