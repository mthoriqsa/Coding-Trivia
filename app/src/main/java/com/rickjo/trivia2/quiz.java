...
public class quiz extends AppCompatActivity {
    ...
    private QuestionDatabase mQuestionLibrary = new QuestionDatabase(this);
    ...
    private int mQuestionNumber = 0; //urutan array
    private int countQuiz = 0; //jumlah soal
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mButtonChoice1.getText().toString().contentEquals(mAnswer)){
                    ...
                    Toast.makeText(quiz.this, "BENAR!", Toast.LENGTH_SHORT).show();
                }
                else {
                    mScore--;
                    lifePoint--;
    ...
    private void updateQuestion(){
        ...
        try {
            if (countQuiz == QUIZ_COUNT){
                ...
                intent.putExtra("algoezScore", mScore);
            ...
            AlertDialog.Builder errorConn = new AlertDialog.Builder(quiz.this);
            errorConn
    ...
    private void gameOver(){
        ...
        alertDialogBuilder
                .setMessage("Game Over! Skor anda : " + mScore + " poin")
                .setCancelable(false)
