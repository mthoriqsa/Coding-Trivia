...
public class quizPHPEZ extends AppCompatActivity {

    private QuestionDatabasePHPEZ mQuestionLibrary = new QuestionDatabasePHPEZ(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_phpez);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mButtonChoice1.getText().toString().contentEquals(mAnswer)){
                    ...
                    Toast.makeText(quizPHPEZ.this, "BENAR!", Toast.LENGTH_SHORT).show();
                }
                else {
                    mScore--;
                    lifePoint--;
                    ...
                    zeroScore();
                    Toast.makeText(quizPHPEZ.this, "SALAH!", Toast.LENGTH_SHORT).show();
                    //gameOver();
                }
            }
        });
    ...
    private void updateQuestion(){
        try {
            if (countQuiz == QUIZ_COUNT) {
                Intent intent = new Intent(getApplicationContext(), resultPHPEZ.class);
                intent.putExtra("phpezScore", mScore);
            ...
            AlertDialog.Builder errorConn = new AlertDialog.Builder(quizPHPEZ.this);
            errorConn
    ...
    private void gameOver(){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(quizPHPEZ.this);
        alertDialogBuilder
                ...
                .setPositiveButton("Restart",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                startActivity(new Intent(getApplicationContext(), quizPHPEZ.class));
                            }
                        })
