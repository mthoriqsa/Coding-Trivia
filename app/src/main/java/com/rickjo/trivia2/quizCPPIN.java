...
public class quizCPPIN extends AppCompatActivity {

    private QuestionDatabaseCPPIN mQuestionLibrary = new QuestionDatabaseCPPIN(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_cppin);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mButtonChoice1.getText().toString().contentEquals(mAnswer)){
                    ...
                    Toast.makeText(quizCPPIN.this, "BENAR!", Toast.LENGTH_SHORT).show();
                }
                else {
                    mScore--;
                    lifePoint--;
                    ...
                    zeroScore();
                    Toast.makeText(quizCPPIN.this, "SALAH!", Toast.LENGTH_SHORT).show();
                    //gameOver();
                }
            }
        });
    ...
    private void updateQuestion(){
        try {
            if (countQuiz == QUIZ_COUNT) {
                Intent intent = new Intent(getApplicationContext(), resultCPPIN.class);
                intent.putExtra("cppinScore", mScore);
            ...
            AlertDialog.Builder errorConn = new AlertDialog.Builder(quizCPPIN.this);
            errorConn
    ...
    private void gameOver(){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(quizCPPIN.this);
        alertDialogBuilder
                ...
                .setPositiveButton("Restart",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                startActivity(new Intent(getApplicationContext(), quizCPPIN.class));
                            }
                        })
