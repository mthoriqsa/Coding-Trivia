...
public class quizPHPIN extends AppCompatActivity {

    private QuestionDatabasePHPIN mQuestionLibrary = new QuestionDatabasePHPIN(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_phpin);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mButtonChoice1.getText().toString().contentEquals(mAnswer)){
                    ...
                    Toast.makeText(quizPHPIN.this, "BENAR!", Toast.LENGTH_SHORT).show();
                }
                else {
                    mScore--;
                    lifePoint--;
                    ...
                    zeroScore();
                    Toast.makeText(quizPHPIN.this, "SALAH!", Toast.LENGTH_SHORT).show();
                    //gameOver();
                }
            }
        });
    ...
    private void updateQuestion(){
        try {
            if (countQuiz == QUIZ_COUNT) {
                Intent intent = new Intent(getApplicationContext(), resultPHPIN.class);
                intent.putExtra("phpinScore", mScore);
            ...
            AlertDialog.Builder errorConn = new AlertDialog.Builder(quizPHPIN.this);
            errorConn
    ...
    private void gameOver(){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(quizPHPIN.this);
        alertDialogBuilder
                ...
                .setPositiveButton("Restart",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                startActivity(new Intent(getApplicationContext(), quizPHPIN.class));
                            }
                        })
