...
public class QuestionDatabasePHPIN {
    Context mContext;
    private String JSON_STRING;
    public QuestionDatabasePHPIN(Context C){
        mContext = C;
    }
    ...
    public String getJSON(){
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                //loading.dismiss();
                getQuestion();
                mContext.startActivity( new Intent(ApplicationContextProvider.getContext(), quizPHPIN.class));
            }

            @Override
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequest(konfigurasi.URL_GET_PHPIN);
                return s;
            }
        }
